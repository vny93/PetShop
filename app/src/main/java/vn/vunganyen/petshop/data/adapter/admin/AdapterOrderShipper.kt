...
import vn.vunganyen.petshop.screens.admin.orderShip.shipperDetailOrder.ShipperOrderMngActivity
...
class AdapterOrderShipper : RecyclerView.Adapter<AdapterOrderShipper.MainViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MainViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener{
            var intent = Intent(holder.itemView.context, ShipperOrderMngActivity::class.java)
