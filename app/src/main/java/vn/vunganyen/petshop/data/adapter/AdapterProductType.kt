...
class AdapterProductType : RecyclerView.Adapter<AdapterProductType.MainViewHolder>() {
    ...
    inner class MainViewHolder(val binding: ItemProductTypeBinding) :
        ...
        fun bindItem(data: ProductTypeRes) {
          ...
          //  binding.imvProductType = HistoryActivity.formatdate3.format(date2)
          //  binding.tvProdcutType.text = data.status
        }
    }
    ...
    override fun onBindViewHolder(holder: MainViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener{
          //  var intent = Intent(holder.itemView.context, ComplaintResolvedActivity::class.java)
